...
public class TextMeshController : MonoBehaviour
{
    ...
    private Renderer m_textMesh_renderer;
    ...
    {
        get { return m_textMesh_renderer.bounds.extents.x * 2.0f; }
    }
    public float TextHeight
    {
        get { return m_textMesh_renderer.bounds.extents.y * 2.0f; }
    }
    ...
    public void Awake()
    {
        ...
        m_textMesh_renderer = m_textMesh.GetComponent<Renderer>();
    ...
    {
        m_textMesh.text = "x x";
        float totalWidth = m_textMesh_renderer.bounds.extents.x * 2.0f;
    ...
    private float GetWordWidth(string word)
    {
        ...
        return m_textMesh_renderer.bounds.extents.x * 2.0f;
    }
